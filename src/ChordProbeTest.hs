--  File     : ChordProbeTest.hs
--  RCS      : $Id$
--  Author   : Peter Schachte
--  Origin   : Sat Aug 20 22:06:04 2011
--  Purpose  : Test program for ChordProbe project submissions
...
main = do
  ...
  if length args == 3 && validChord target then do
    ...
    putStrLn "Usage:  chordprobe p1 p2 p3"
    putStrLn "   where p1 p2 p3 are 3 different pitches between A1 and G3"
    exitFailure


loop :: [String] -> [String] -> ChordProbe.GameState -> Int -> IO ()
